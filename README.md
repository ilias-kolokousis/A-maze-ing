...
![PyPI](https://img.shields.io/pypi/v/a-maze-ing-generator-il-lu)
...
| `width`, `height` | Min 4×4, max 25×25 (depending on your screen size). `height` is never greater than `width`. |
...
- [Lukas van Hemmen](https://github.com/KULUSKULS)
